...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button addButton = findViewById(R.id.add_stock);
        if (mCurrentBookUri == null) {
            ...
            addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int increment = valueInt + 1;
                    mQuantityEditText.setText(String.valueOf(increment));
                }
            });
        }

        Button minusButton = findViewById(R.id.minus_stock);
        if (mCurrentBookUri == null) {
            ...
            minusButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (valueInt <= 0) {
                        valueInt = 0;
                        mQuantityEditText.setText(String.valueOf(valueInt));
                    } else {
                        int decrement = valueInt - 1;
                        mQuantityEditText.setText(String.valueOf(decrement));
                    }
                }
            });
        }
        ...
        //if new inventory, hide order more button
        if (mCurrentBookUri == null) {
            orderButton.setVisibility(View.GONE);
        } else {
            // if existing inventory, allow user to order more
    ...
    private void saveBook() {
        ...
        if (mCurrentBookUri == null &&
                ...
                TextUtils.isEmpty(phoneString) && TextUtils.isEmpty(quantityString) &&
        ...
        values.put(BookContract.BookEntry.COLUMN_BOOK_PHONE, phoneString);
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage(R.string.unsaved_dialog_changes);
    ...
    public void dialPhoneNumber() {
        ...
        dialIntent.setData(Uri.parse("tel:" + mPhoneEditText.getText().toString()));
